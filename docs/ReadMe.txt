...
/*-----------------------------------------------------DEVELOPMENT----------------------------------------------------*/
The project was developed with the cross-platform IDE "PhpStorm 2017.2.4".

/*----------------------------------------------EXTENDING VISUALIZATION-----------------------------------------------*/
All functions which are used for visualization like highlighting, drawing arrows
and functions which are used to access information are stored in "scripts/post_processing/visualizer.js".
This class is working closely together with the "scripts/post_processing/input_processor.js" class
...
Examples for simulated inheritance you find under "scripts/procedures/bases/":
...
/*---------------------------------------------------INPUT HANDLING---------------------------------------------------*/
The "InputProcessor"-class under "scripts/post_processing/input_processor.js"
...
/*-----------------------------------------------------INTERFACES-----------------------------------------------------*/
Interfaces under "pages/interfaces/" can be used to offload the algorithm input and output (the interface).
...
by a javascript file, which have the same name like the related page under "pages/interfaces/",
but the file extension is ".js".

/*------------------------------------IMPLEMENTING NEW ALGORITHM FOR VISUALIZATION------------------------------------*/
-   create a new page "example_algorithm.html" in "pages/"
    (use underscores for the page name to make "alignment.js" recognizing the new page)
-   create a new script "example_algorithm.js" in "scripts/"
...
by storing all algorithms of same type in one file "scripts/procedures/".
For example all algorithms for backtracking are stored in "scripts/procedures/backtracking.js"
and all algorithms for clustering are stored in "scripts/procedures/clustering.js".

/*-------------------------------------------------------TESTS--------------------------------------------------------*/
Unit-Tests are stored under "scripts/tests/". The file "UnitTests.jstd" is specifying Unit-Test file paths.
